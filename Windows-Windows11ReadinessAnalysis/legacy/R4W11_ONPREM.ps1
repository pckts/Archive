$Resultdump = "\\SERV\R4W11$\ClientData.csv" #FX \\DC01\R4W11$\ClientData.csv
...
$Collection | Select Username, Hostname, CPUScore, RAMScore, DiskScore, UEFIScore, SBScore, TPMScore, FINALScore | export-csv $ResultDump -NoTypeInformation -Encoding Unicode -Append